const DEFAULT_PHOTOS: Record<string, string> = {
  ...
  electricien: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=400&h=400&fit=crop",
  ...
  menuisier: "https://images.unsplash.com/photo-1558618019-44bc87907eaa?w=400&h=400&fit=crop",
