      ...
      <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-lg border border-black/10 bg-creme text-anthracite/60"
                readOnly
              />
            </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-sm text-anthracite/50">49 EUR/mois</span>
          </div>
          <ul className="space-y-1 text-sm text-anthracite/60 mb-4">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          <div className="flex items-center gap-2 p-3 bg-creme rounded-lg mb-4">
          ...
          <p className="text-xs text-anthracite/40">QR Code disponible avec le plan Pro</p>
        </div>

        <div className="bg-white rounded-xl p-6 shadow-sm border border-red-100">
          <h2 className="font-display text-lg font-bold text-red-600 mb-2">Zone de danger</h2>
          <p className="text-sm text-anthracite/50 mb-4">
