      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          <textarea
            ...
            className="w-full px-4 py-2.5 rounded-lg border border-black/10 focus:ring-2 focus:ring-terre/30 focus:border-terre outline-none resize-none"
          />
        </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {["RGE", "Qualibat", "Assurance decennale"].map((b) => (
              <span key={b} className="frosted px-3 py-1.5 rounded-full text-sm text-anthracite border border-black/5">
                {b}
              </span>
            ))}
          </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          <div className="space-y-3 mb-4">
            {["Depannage plomberie", "Renovation salle de bains", "Installation chauffage"].map((s) => (
              <div key={s} className="flex items-center justify-between p-3 bg-creme rounded-lg">
