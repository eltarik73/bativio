...
const NAV: { href: string; label: string; icon: string; badge?: string; sep?: boolean; businessOnly?: boolean }[] = [
...
const MOB = [
  ...
  { href: "/dashboard/demandes-projets", label: "Bativio", icon: '<svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M9.937 15.5A2 2 0 008.5 14.063l-6.135-1.582a.5.5 0 010-.962L8.5 9.937A2 2 0 009.937 8.5l1.582-6.135a.5.5 0 01.962 0L14.063 8.5A2 2 0 0015.5 9.937l6.135 1.582a.5.5 0 010 .962L15.5 14.063a2 2 0 00-1.437 1.437l-1.582 6.135a.5.5 0 01-.962 0L9.937 15.5z"/></svg>' },
  ...
  return (
    <ProtectedRoute>
      <div style={{ display: "flex", minHeight: "100dvh", background: "#FAF8F5" }}>
        {/* Sidebar desktop */}
        <aside style={{ width: 252, flexShrink: 0, background: "var(--blanc,#fff)", borderRight: "1px solid var(--sable,#E8D5C0)", flexDirection: "column", height: "100dvh", position: "sticky", top: 0, overflow: "hidden" }} className="hidden md:!flex">
          ...
          <nav style={{ flex: 1, minHeight: 0, overflowY: "auto", display: "flex", flexDirection: "column", gap: 2, padding: "0 12px" }}>
            {NAV.filter((item) => !item.businessOnly || effectivePlan === "business").map((item) => {
